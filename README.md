...
Поддерживаются нормальные, поперечные и косые аспекты (поворот задаётся `lambda0`/`phiOrigin`/`gamma`).
...
> **Модель Земли:** только **сферическая**. Равноугольная азимутальная проекция —
> это стереографическая; источник света («Источник света») для азимутальных: центр →
> гномоническая, антипод → стереографическая, бесконечность → ортографическая,
> «математическая» → аналитическая (равновеликая/равнопромежуточная). Для цилиндрических
> семейств отдельного «источника света» нет — глобус разворачивается на цилиндр.

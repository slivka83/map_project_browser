...
центрирует выбранную параллель в средней строке, а рамка обрезки — **неподвижный кадр экрана**:
она никогда не двигается вместе с Параллелью 1, под стабильным окном прокручивается только
содержимое — точно как по долготе. Сам закон высоты зажимается лишь до ±`CLAMP_LAT`
...
иначе d3 изгибает прямые параллели в дуги и карта выглядит «яйцом».

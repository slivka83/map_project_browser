...
поэтому три копии слоя, составленные через высоту полосы (`createProjectionTiles`), и дальше
образуют бесшовную бесконечную вертикальную ленту при любом положении ползунков (прокрутка
за край входит с противоположной стороны). Материки и границы заранее перекатываются в систему

...
// the current variant; the family is conveyed by the icon) and the narrow
// right one resets the parameters. It owns the catalog-modal state so the
// control panel below stays focused on parameter sliders.

...
export const EPSG_PRESETS: EpsgEntry[] = [
  ...
  { code: 'EPSG:53010', name: 'Галль–Петерс', type: 'Галль–Петерс', units: 'градусы', params: { variant: 'equirectangular', family: 'cylindrical', distortion: 'equalArea', phiOrigin: 45 } },
  { code: 'EPSG:54004', name: 'Бергман', type: 'Бергман', units: 'градусы', params: { variant: 'equirectangular', family: 'cylindrical', distortion: 'equalArea', phiOrigin: 30 } },
  { code: 'EPSG:54008', name: 'Хобо–Дайер', type: 'Хобо–Дайер', units: 'градусы', params: { variant: 'equirectangular', family: 'cylindrical', distortion: 'equalArea', phiOrigin: 37.5 } },
  { code: 'EPSG:54009', name: 'Тристан-Эдвардс', type: 'Тристан-Эдвардс', units: 'градусы', params: { variant: 'equirectangular', family: 'cylindrical', distortion: 'equalArea', phiOrigin: 37.5 } },
  { code: 'EPSG:54006', name: 'Бальтасар', type: 'Бальтасар', units: 'градусы', params: { variant: 'equirectangular', family: 'cylindrical', distortion: 'equalArea', phiOrigin: 50 } },
  ...
  { code: 'EPSG:54007', name: 'Крастер (равновеликая)', type: 'Крастер', units: 'градусы', params: { variant: 'equirectangular', family: 'cylindrical', distortion: 'equalArea', phiOrigin: 62 } },
  ...
  { code: 'EPSG:9820b', name: 'Стереографическая (Южный полюс)', type: 'Стереографическая', units: 'градусы', params: { variant: 'stereographic', family: 'azimuthalPerspective', distortion: 'conformal', phiOrigin: -90, azLight: 'antipode' } },
  ...
  { code: 'EPSG:54001c', name: 'Азимутальная равнопромежуточная (Мир)', type: 'Азимутальная равнопромежуточная', units: 'градусы', params: { variant: 'azimuthalEquidistant', family: 'azimuthalMath', distortion: 'equidistant', phiOrigin: 0 } },
  ...
  { code: 'EPSG:9841', name: 'Ортографическая', type: 'Ортографическая', units: 'градусы', params: { variant: 'orthographic', family: 'azimuthalPerspective', distortion: 'equidistant', phiOrigin: 0, azLight: 'infinity' } },
];

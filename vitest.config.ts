  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/components/VizMethodRenderer.tsx',
        'src/components/PerpendicularNormals.tsx',
        'src/components/ParticleTransfer.tsx',
        'src/components/MagneticField.tsx',
        'src/components/PeelOff.tsx',
        'src/components/WaveProjection.tsx',
        'src/components/LaserScanner.tsx',
        'src/components/GeometricConstruction.tsx',
        'src/components/ShadowPlay.tsx',
        'src/components/CircularSlider.tsx',
        'vitest.config.ts',
        'vitest.setup.ts',
      ],
    },

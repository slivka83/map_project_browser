...
detailedMap: boolean;                       // 2D map detail toggle (default true → 50m land + borders; false → lightweight 110m land, no borders)
```
